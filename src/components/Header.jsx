...
const Header = () => {
  ...
  return (
    ...
    <div className="xl:w-1/6 text-center -mt-4">
      <a href='#' className="text-2xl font-bold relative p-1 bg-white">Power<span className='text-blue-500 text-5xl'>.</span>{" "} <RiCheckboxBlankCircleFill className='absolute -left-3 -bottom-3 text-blue-500 -z-10'/></a>
    </div>
